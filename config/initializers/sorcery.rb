...
Rails.application.config.sorcery.configure do |config|
  ...
  # Default: `[]`
  #
  config.external_providers = [:google] # ✅ Googleログインを有効化
  ...
  # （どちらもGoogle Cloud Consoleの「承認済みのリダイレクトURI」に登録済み）
  ...
  config.user_config do |user|
    ...
    # Default: `nil`
    #
    user.authentications_class = Authentication # ✅ SNS連携情報を保存するモデル

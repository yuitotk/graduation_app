...
module Users
  ...
  class SampleContentSeeder
    ...
    UNPLACED_IDEA_DEFINITIONS = [
      ...
      { title: "屋根裏で見つかった、動く人形（ファンタジー）",
        memo: "祖母の家の屋根裏を片付けていたら、古い人形が出てきた。埃を払った瞬間、人形がわずかに" \
              "首を動かした気がした。人形の正体や、なぜ動くのかを考えるところからファンタジーに" \
              "広げやすいアイデア。" },
      { title: "モテたい後輩に頼まれた、嘘の彼女役（コメディ）",
        memo: "後輩から「モテたいから、少しの間だけ彼女のふりをしてほしい」と頼まれた。断りきれず" \
              "引き受けたものの、思ったより大ごとになっていきそうな予感がする。この後どう転がって" \
              "いくのかを考えるところから広げやすいアイデア。" },
      { title: "祖父の家にあった、宛名のない手紙（ヒューマンドラマ）",
        memo: "祖父が亡くなって数年後、遺品の中から自分宛てらしい、しかし宛名のない手紙が見つかった。" \
              "中身はまだ読んでいない。何が書かれているのか、なぜ今になって見つかったのかを考えるところから" \
              "広げやすいアイデア。" }
    ].freeze
